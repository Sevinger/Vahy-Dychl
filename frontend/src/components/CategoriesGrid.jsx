      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 md:mb-16">
          ...
          <p className="text-base md:text-lg text-slate-500 mt-3 max-w-xl">
            Široký sortiment vážicí techniky a pokladních systémů pro každé odvětví.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 auto-rows-[260px] gap-4" data-testid="categories-grid">
          {categories.map((cat, i) => (
            <div
              key={cat.title}
              className={`category-card group relative overflow-hidden border border-slate-200 hover:border-orange-500/40 cursor-pointer transition-all duration-300 ${cat.span}`}
            ...
            >
              ...
              <div className="relative h-full flex flex-col justify-end p-6 md:p-8">
                ...
                <div className="flex items-center gap-1 mt-4 text-orange-400 group-hover:text-orange-300 transition-colors">
